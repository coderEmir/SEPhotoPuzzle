...
+ (UIImage *)imageWithContentsOfFile:(NSString *)path currentClass:(id)currentClass
{
    NSString *fileName = [NSString stringWithFormat:@"SEPhotoPuzzle.bundle/Assets/%@.png",path];
    NSString *filePath = [[NSBundle bundleForClass:[currentClass class]].resourcePath stringByAppendingPathComponent:fileName];
    NSLog(@"%@",filePath);
