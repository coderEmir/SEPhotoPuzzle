...
@property (nonatomic , copy) NSString *floderNum;
@end
...
- (void)initResource
{
    ...
    for (int i = 0; i < [imageNameArray count]; i++) {
        ...
        NSString *filePath = [NSString stringWithFormat:@"templates/number_%@/%@",self.floderNum,[imageNameArray objectAtIndex:i]];
        [button setImage:[UIImage imageWithContentsOfFile:filePath currentClass:self] forState:UIControlStateNormal];
        [button setBackgroundImage:[UIImage imageWithContentsOfFile:@"makecards_puzzle_storyboard_strokr_icon" currentClass:self] forState:UIControlStateHighlighted];
        [button setBackgroundImage:[UIImage imageWithContentsOfFile:@"makecards_puzzle_storyboard_strokr_icon" currentClass:self] forState:UIControlStateSelected];
